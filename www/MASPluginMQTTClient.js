...
* @classdesc The MAS Messaging client which connects to any Public Broker including MAG
* @param {string} clientId Unique broker-client ID for this client. Default is the one picked from msso_config.json
* @param {MASPluginMQTTConstants} masMQTTConstants instance of fully populated MASPluginMQTTConstants object.
*/
var MASPluginMQTTClient = function (clientId, masMQTTConstants) {
    ...
    */
    ...
    /**
	* Connects to a message broker using the MASPluginMQTTConstants provided during contruction of this object.
    * @memberOf MASPluginMQTTClient
	* @function connect
	* @instance
    * @param {successCallbackFunction} successHandler user defined success callback which will be invoked on success scenario.
	...
	*/
	...
	/**
	* Subscribe to a topic via the connected MQTT broker.
    * @memberOf MASPluginMQTTClient
	* @function subscribe
	* @instance
    * @param {successCallbackFunction} successHandler user defined success callback which will be invoked on success scenario.
